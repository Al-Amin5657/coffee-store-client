    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <div className="md:flex">
                    ...
                    <div className="form-control md:w-1/2 ml-4">
                        ...
                        <label className="input-group">
                            ...
                            <input type="text" name="taste" defaultValue={taste} placeholder="Taste Name" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
                ...
                <input type="submit" value="Update Coffee" className="btn btn-block bg-[#D2B48C] mt-8" />
            </form>
        </div>
    );
};
